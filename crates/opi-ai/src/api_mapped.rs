...
//! provider delegates a collection-prepared request and opaque authentication
//! to the concrete route selected by wire API. Resolver ownership stays in
//! [`crate::ProviderCollection`], outside this adapter.
