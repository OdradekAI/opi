#!/usr/bin/env python3
"""Contract tests for the Phase 18 materialization CI verifier.
...
def valid_workflow_text(trigger: str = "workflow_dispatch") -> str:
    return (
        "name: Phase 18 lock materialization\n"
        f"on:\n  {trigger}:\n    inputs:\n      candidate_sha:\n        required: true\n"
        "permissions:\n  contents: read\n"
        "concurrency:\n  group: phase18-lock-materialization\n"
...
def valid_static_lock(
    ...
    schema: str = "phase18-external-lock/static/1",
) -> dict:
    return {
        "schema": schema,
...
class Workspace:
    ...
    def __init__(
        ...
        self.root = Path(tempfile.mkdtemp(prefix="phase18-ci-verify-"))
        workflow_text = (
