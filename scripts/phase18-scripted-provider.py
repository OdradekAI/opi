...
(task 18.10.1) reads one JSON request line per turn from stdin and writes
one fixed JSON response line to stdout, exiting at EOF or after the bounded
request cap; it makes no network connection. Listener mode (task 18.14.1)
...
ambient variables, or user/project resources (P18-AGT-006); no oracle or
